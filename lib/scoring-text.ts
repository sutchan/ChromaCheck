...
export const SEVERITY_TEXT: Record<string, string> = { mild: '轻度', moderate: '中度', severe: '重度' };
...
export const MODE_TEXT: Record<TestMode, string> = { quick: '快速版', standard: '标准版', advanced: '进阶版' };
